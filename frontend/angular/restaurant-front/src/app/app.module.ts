...
import { RestaurantMenuPostComponent } from './restaurant-menu-post/restaurant-menu-post.component';
...
@NgModule({
  ...
  imports: [
    RouterModule.forRoot([
      ...
      {
        path: 'restaurant/:id/post',
        component: RestaurantMenuPostComponent
      },
      {
